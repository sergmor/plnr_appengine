 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "columbia.edu", ownerName = "columbia.edu", packagePath="cloud.plnr"))
...
public class MessageEndpoint {
   ...
   */
  private static final String API_KEY = "AIzaSyAD4apBq0H58TDFgINT0gtgHhHVNYILDMI";
