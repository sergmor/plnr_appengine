...
import edu.columbia.cloud.plnr.EMF;
...
@Api(name = "deviceinfoendpoint", namespace = @ApiNamespace(ownerDomain = "columbia.edu", ownerName = "columbia.edu", packagePath = "cloud.plnr"))
